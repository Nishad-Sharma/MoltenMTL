...
public final class CAMetalLayer {
    ...
    private let imageAvailableSemaphore: VkSemaphore
    ...
    private let renderFinishedSemaphores: [VkSemaphore]
    ...
    public func nextDrawable() -> CAMetalDrawable? {
        ...
        return CAMetalDrawable(
            ...
            renderFinishedSemaphore: renderFinishedSemaphores[Int(idx)],
    ...
    deinit {
        ...
        renderFinishedSemaphores.forEach { vkDestroySemaphore(vkDev, $0, nil) }
        vkDestroySemaphore(vkDev, imageAvailableSemaphore, nil)
    }
}
