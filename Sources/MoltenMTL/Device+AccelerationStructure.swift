...
public extension MTLDevice {
    ...
    func makeAccelerationStructure(size: Int) -> MTLAccelerationStructure? {
        ...
        guard CVMA_createBuffer(vmaAlloc,
                                ...
                                nil) == VK_SUCCESS,
              let buf else {
            print("[VulkanSwift] makeAccelerationStructure: buffer allocation failed")
            return nil
        }
        ...
        guard CVKAS_createAccelerationStructure(vkDev, &createInfo, &handle) == VK_SUCCESS,
              let handle else {
            print("[VulkanSwift] makeAccelerationStructure: vkCreateAccelerationStructureKHR failed")
