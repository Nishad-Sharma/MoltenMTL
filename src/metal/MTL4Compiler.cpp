...
MTLLibrary* MTL4CompilerNewLibrary(MTL4Compiler* c, const MTL4LibraryDescriptor* d, MTLError** error)
{
...
MTLComputePipelineState* MTL4CompilerNewComputePipelineState(MTL4Compiler* c, const MTL4ComputePipelineDescriptor* d, MTLError** error)
{
    if (error) *error = nullptr;
    if (!c || !d) return nullptr;
    NS::Error* e = nullptr;
